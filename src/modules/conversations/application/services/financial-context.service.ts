...
export class FinancialContextService {
  ...
  private toPrompt(summary: Omit<FinancialContextSummary, 'prompt'>): string {
    ...
    return [
      ...
      '',
      'Guia de funcionalidades reales de Zenda:',
      '- Movimientos: el usuario puede registrar ingresos, gastos y transferencias; tambien puede usar OCR de boletas y entrada por voz para preparar un borrador.',
      '- Categorias: existen categorias base y el usuario puede crear, renombrar o eliminar categorias personalizadas. Si pregunta como hacerlo, indicar que vaya a Perfil > Categorias.',
      '- Presupuestos: son limites mensuales por categoria; no son cuentas donde se deposita dinero. Los gastos registrados actualizan el consumo automaticamente.',
      '- Cuentas: el usuario puede manejar efectivo, banco, billetera digital y tarjeta de credito como deuda; las transferencias mueven saldo entre cuentas.',
      '- Metas: el usuario puede crear metas de ahorro y agregar aportes para avanzar hacia un monto objetivo.',
      '- Reportes: muestran resumen diario/semanal/mensual, categorias principales, comparativos y progreso financiero.',
      '- Educacion: incluye topicos, quizzes y quizzes personalizados con IA para reforzar educacion financiera.',
      '',
      'Privacidad:',
